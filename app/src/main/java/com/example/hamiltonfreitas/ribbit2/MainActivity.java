        ...
        public void onClick(DialogInterface dialog, int which) {
            switch (which){
                case 0: //Take a picture
                    ...
                    if(mMediaUri == null){
                        Toast.makeText(MainActivity.this, R.string.erro_external_storage,Toast.LENGTH_LONG).show();
                    }else {
        ...
        if(resultCode == RESULT_OK){
            if(requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST){
                ...
                if(requestCode == PICK_VIDEO_REQUEST){
                    //Make sure file requested is less that 10 MB
                    int fileSize = 0;
            ...
            Intent recipientIntent = new Intent(this, ChooseFriend.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            ...
            case R.id.action_edit_friends:
                Intent intent = new Intent(this, EditMyFriendsActivity.class);
                startActivity(intent);
                break;
